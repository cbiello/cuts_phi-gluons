...
(* ::Text:: *)
(*Reintroducing the pre-factor, we obtain*)


2*s[4]/(spA[1,2]spA[2,3]spA[3,1]*3/s[4])


(* ::Text:: *)
(*Hence the bubble coefficient is -1/3*A^{1L}.*)
